        ...
        <div className="div_detail">
            ...
            {devis.map((devis) => (
                <div key={devis.id} className="div_row" style={{justifyContent: "space-between"}}>
                    <div>
                        <label className="label_info_classic">{devis.nomDevis}</label>
                    </div>
                    <div>
                        <label className="label_info_classic">{devis.nomPersonne}</label>
                    </div>
                    <div>
                        <label className="label_info_classic">{devis.prenom}</label>
                    </div>
                    <div>
                        <label className="label_info_classic">{formatDateToLocalString(devis.dateCreation)}</label>
                    </div>
                    <div>
