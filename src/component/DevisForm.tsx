        ...
        <div className="div_devis">
            <form className="div_devis_content" onSubmit={handleSubmit}>
                ...
                <div className="div_localisation">
                    <div>
                        <div className="div_form" style={{marginRight: "80px"}}>
                            <label>Adresse de votre logement <label className="label_required">(Requis)</label></label>
                            <input value={adresse} onChange={(e) => setAdresse(e.target.value)} required></input>
                        </div>
                        <div className="div_form">
                            <label>Code postal de votre logement <label className="label_required">(Requis)</label></label>
                            <input minLength={5} maxLength={5} value={codePostal} onChange={(e) => setCodePostal(e.target.value)} required></input>
                        </div>
                    </div>
                    <div className="div_form">
                        <label>Ville de votre logement <label className="label_required">(Requis)</label></label>
                        <input value={ville} onChange={(e) => setVille(e.target.value)} required />
                    </div>
                    <div className="div_form">
                        <label>Pays de votre logement <label className="label_required">(Requis)</label></label>
                ...
                <div className="div_devis_champs">
                    <div className="div_form" style={{marginRight: "80px"}}>
                        <label>Type de bien <label className="label_required">(Requis)</label></label>
                    ...
                    <div className="div_form">
                        <label>Type de Location <label className="label_required">(Requis)</label></label>
                ...
                <div className="div_form div_devis_champs">
                    <label>Nombre de chambres <label className="label_required">(Requis)</label></label>
                    <input min={0} value={nbChambres} onChange={(e) => setNbChambres(+e.target.value)} required></input>
                </div>
                <div className="div_form div_devis_champs">
                    <label>Quelle est la capacité d'accueil de votre logement ? <label className="label_required">(Requis)</label></label>
                    <input min={1} value={capacite} onChange={(e) => setCapacite(+e.target.value)} required></input>
                </div>
                <div className="div_devis_champs">
                    <div className="div_form" style={{marginRight: "80px"}}>
                        <label>Surface (en m²) <label className="label_required">(Requis)</label></label>
                        <input min={9} value={surface} onChange={(e) => setSurface(+e.target.value)} required></input>
                    </div>
                    <div className="div_form">
                        <label>Prix par nuit (en €) <label className="label_required">(Requis)</label></label>
                ...
                <div className="div_devis_champs">
                    <div className="div_form" style={{marginRight: "80px"}}>
                        <label>Nom <label className="label_required">(Requis)</label></label>
                        <input value={nom} onChange={(e) => setNom(e.target.value)} required></input>
                    </div>
                    <div className="div_form">
                        <label>Prénom  <label className="label_required">(Requis)</label></label>
                ...
                <div className="div_devis_champs">
                    <div className="div_form" style={{marginRight: "80px"}}>
                        <label>Email <label className="label_required">(Requis)</label></label>
                        <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" required></input>
                    </div>
                    <div className="div_form">
                        <label>Téléphone <label className="label_required">(Requis)</label></label>
